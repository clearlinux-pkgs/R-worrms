...
Version  : 0.3.0
Release  : 4
URL      : https://cran.r-project.org/src/contrib/worrms_0.3.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/worrms_0.3.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1541734003
