...
Version  : 0.2.8
Release  : 3
URL      : https://cran.r-project.org/src/contrib/worrms_0.2.8.tar.gz
Source0  : https://cran.r-project.org/src/contrib/worrms_0.2.8.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1530368955
